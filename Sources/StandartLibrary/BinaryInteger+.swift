public extension BinaryInteger {
    ...
    ///
    @inlinable var toDouble: Double { Double(self) }
    ...
    ///
    @inlinable func times(_ body: (Int) -> Void) -> Void {
    ...
    ///     // Prints "Hello, world!"
    ///
    @inlinable func times(_ body: () -> Void) -> Void {
        guard self > 0 else { return }
    ...
    ///
    @inlinable mutating func clamp(to limits: Range<Self>) -> Void {
    ...
    ///     number.clamp(to: limits) // 7
    ///
    @inlinable mutating func clamp(to limits: PartialRangeFrom<Self>) -> Void {
        self = clamped(to: limits)
    }
    ...
    ///     number.clamp(to: limits) // 5
    ///
    @inlinable mutating func clamp(to limits: PartialRangeThrough<Self>) -> Void {
        self = clamped(to: limits)
    }
